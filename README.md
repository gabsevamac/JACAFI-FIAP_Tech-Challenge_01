...
Docker e Compose são mantidos para o desenvolvimento local. Manifestos Kubernetes, Terraform e pipeline CI/CD serão adicionados na etapa específica de infraestrutura da Fase 2.
