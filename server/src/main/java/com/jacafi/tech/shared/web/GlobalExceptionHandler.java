...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    /**
     * The only exceptions whose message reaches the client, because they are the only ones written
     * for the client.
     */
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(
        ...
        return ResponseEntity.status(ErrorCode.MALFORMED_BODY.status()).body(problem(ErrorCode.MALFORMED_BODY));
    }
    ...
    private static ProblemDetail problem(ErrorCode code, String detail) {
        return problem(code, detail, code.status());
    }
