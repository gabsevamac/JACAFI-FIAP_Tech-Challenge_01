 ...
 * only strings and numbers, and turning those into a {@code LicensePlate} is the use case's job — which is also where the resulting validation failure belongs.
 *
