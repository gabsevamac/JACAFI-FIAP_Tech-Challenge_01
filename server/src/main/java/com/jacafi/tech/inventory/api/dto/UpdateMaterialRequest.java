...
public record UpdateMaterialRequest(
        ...
        @Schema(description = "Price charged per unit from now on. Orders already priced keep the "
                + "price frozen at the moment their items were launched.", example = "54.90")
