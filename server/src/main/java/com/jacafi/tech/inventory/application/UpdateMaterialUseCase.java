...
public class UpdateMaterialUseCase {
    ...
    public UpdateMaterialUseCase(InventoryItemRepository repository, InventoryAuditTrail auditTrail, Clock clock) {
    ...
    public InventoryItem update(UpdateMaterialCommand command) {
        ...
        auditTrail.append(
                InventoryAuditEntry.of(item.getId(), AuditedOperation.UPDATED, command.actor(), clock.instant()));
