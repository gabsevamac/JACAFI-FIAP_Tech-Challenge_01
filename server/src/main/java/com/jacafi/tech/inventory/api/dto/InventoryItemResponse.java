...
public record InventoryItemResponse(
        ...
        @Schema(description = "Units physically on the shelf, reserved ones included") int quantityOnHand,
        @Schema(description = "Units held by open reservations") int quantityReserved,
        @Schema(description = "Units a new order could still be promised") int quantityAvailable,
    ...
    public static InventoryItemResponse from(InventoryItem item) {
        return new InventoryItemResponse(item.getId(),
                ...
                item.quantityReserved().value(),
                item.quantityAvailable().value(),
