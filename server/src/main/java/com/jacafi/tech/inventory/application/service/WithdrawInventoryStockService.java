...
public class WithdrawInventoryStockService {
    ...
    public WithdrawInventoryStockService(
    ...
    public StockWithdrawal withdraw(UUID id, UUID serviceOrderId) {
        ...
        ledger.append(InventoryAuditEntry.movement(
                id, AuditedOperation.WITHDRAWN, serviceOrderId, withdrawal.quantity(), actor, at));
        auditTrail.record(new AuditEvent("InventoryItem", id, "WITHDRAWN", actor, at));
        return withdrawal;
    }
}
