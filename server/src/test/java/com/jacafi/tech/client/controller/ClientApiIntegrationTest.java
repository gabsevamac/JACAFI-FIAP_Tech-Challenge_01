...
@SpringBootTest(properties = {
        "spring.datasource.url=jdbc:tc:postgresql:16-alpine:///jacafi-client-api",
...
class ClientApiIntegrationTest {
    ...
    @Test
    void executesTheCompleteClientFlow() throws Exception {
        var location = mvc.perform(post("/api/v1/clients")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("""
                                {
                                  "personType": "LEGAL_ENTITY",
                                  "taxIdentifier": "00.000.000/E08G-12",
                ...
                .andExpect(jsonPath("$.taxIdentifier").value("00000000E08G12"))
                .andReturn()
                .getResponse()
                .getHeader("Location");
        ...
        mvc.perform(get("/api/v1/clients/lookup")
                        .param("personType", "LEGAL_ENTITY")
                        .param("taxIdentifier", "00.000.000/E08G-12"))
                .andExpect(status().isOk())
        ...
        mvc.perform(get("/api/v1/clients").param("active", "false"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.content[*].taxIdentifier", hasItem("00000000E08G12")));
    }
